...
private slots:
    ...
    void on_comboBox_6_activated(const QString );

    void on_comboBox_7_activated(const QString );

    void on_comboBox_8_activated(const QString);

    void on_comboBox_9_activated(const QString );
